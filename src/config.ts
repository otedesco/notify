...
export const NOTIFICATION_SERVICE =
  environment.NOTIFICATION_SERVICE || "hermes";
...
export const NOTIFICATION_SERVICE_URL =
  environment.NOTIFICATION_SERVICE_URL || "127.0.0.1:8000/cerberus";
export const NOTIFICATION_SERVICE_API_KEY =
  environment.NOTIFICATION_SERVICE_API_KEY || "admin";

export const AUTH_SERVICE_URL =
  environment.AUTH_SERVICE_URL || "127.0.0.1:8000/hermes";
export const AUTH_SERVICE_API_KEY =
  environment.NOTIFICATION_SERVICE_API_KEY || "admin";
